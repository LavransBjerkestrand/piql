...
(OrgChart.prototype.load = function (t) {
  ...
  (OrgChart.prototype._pagesA100 = function (t, e, r) {
    ...
    for (
      var g = n, p = l, f = d.w * (100 / r) - n, u = d.h * (100 / r), C = [];
      g < s - 1;
      ...
      if (!1 !== OrgChart.events.publish("drag", [this, i])) {
        ...
        var k = function (t, e) {
            if (null != t) {
              var r = m.getBGNode(t);
              r.isChildOfGroup &&
                (m.getNodeElement(r._groupParentNodeId).style.opacity = 1),
                (e.style.opacity = 1);
            }
          },
          s = function (t) {
          ...
          h = function (t) {
            if (
              ...
              l.id == u ||
                (l.isChildOfGroup && l._groupParentNodeId == u) ||
                null == u)
            )
            ...
            if (null == m.config.dragDropMenu || (l.isGroup && !e.isGroup))
              m._canUpdateLink(l.id, u)
                ? m.linkNode(l.id, u)
                : (O.removeChild(_), k(u, C));
              ...
              if (Array.isArray(l.tags))
                for (var a = 0; a < l.tags.length; a++) {
                  var o = l.tags[a];
                  m.config.tags[o] &&
                    m.config.tags[o].dragDropMenu &&
                    (i = m.config.tags[o].dragDropMenu);
                }
      ...
      if (OrgChart.server._isVisible(A, i, s, d)) {
        ...
        if (
          ...
          if ((L = g[c.id])) {
            for (
              E = A.parent;
              null != E &&
              -1 == c.ids.indexOf(A.id) &&
              -1 == c.ids.indexOf(E.id);
          ...
          var B;
          if (
            (null != (T = f[A.id]).x && null != T.y && (N = { x: T.x, y: T.y }),
            (B = g[c.id]) && B == A)
          )
            (E = A.parent) &&
              E.id == c.id &&
              (N = { x: B.x + B.w / 2 - A.w / 2, y: B.y + B.h / 2 - A.h / 2 });
        ...
        null != N &&
          ...
          ((N.x == A.x && N.y == A.y) ||
            ...
            m[2].push({ transform: [1, 0, 0, 1, A.x, A.y] })));
      }
    }
    return {
      animations: m,
  ...
  (OrgChart.prototype.zoom = function (t, e, r) {
    // overskrive zoom center/anchor som egentlig er musepekerens posisjon
    e = [50, 50];
    ...
    for (var r, i, a, o, n, l = "", s = 0; s < this.config.clinks.length; s++) {
      ...
      if (
        ...
        switch (this.config.orientation) {
          ...
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (O.x = x <= y ? ((_ = -1), x + d.w / 10) : ((_ = 1), x - d.w / 10)),
              (v.x = y + c.w / 10),
              p == u
